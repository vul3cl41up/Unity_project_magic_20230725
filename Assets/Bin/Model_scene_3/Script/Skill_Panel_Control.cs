    ...
    public class Skill_Panel_Control : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            for(int i = 0;i < skill_pool_data.skill_list.Count;i++)
            {
                ...
                new_skill_slot.GetComponent<Skill_Data_Control>().init_skill_data = skill_pool_data.skill_list[i];
                new_skill_slot.GetComponent<Image>().sprite = skill_pool_data.skill_list[i].skill_image;
        ...
        private void DisplayDescription()
        {
            ...
            {
                Skill_Data selected_skill_data = selected.GetComponent<Skill_Data_Control>().init_skill_data;
        ...
        public void Choose()
        {
            if (Input.GetButtonDown("Submit") && selected.CompareTag("Skill_button") && choose_count <= 4)
            {
                ...
                new_skill_selected_slot.GetComponent<Skill_Data_Control>().init_skill_data = selected.GetComponent<Skill_Data_Control>().init_skill_data;
                new_skill_selected_slot.GetComponent<Image>().sprite = selected.GetComponent<Skill_Data_Control>().init_skill_data.skill_image;
        ...
        public void StartGame()
        {
            if(choose_count == 4)
            {
                init_character_data.skill_1 = skill_grid.transform.GetChild(1).gameObject.GetComponent<Skill_Data_Control>().init_skill_data;
                init_character_data.skill_2 = skill_grid.transform.GetChild(2).gameObject.GetComponent<Skill_Data_Control>().init_skill_data;
                init_character_data.skill_3 = skill_grid.transform.GetChild(3).gameObject.GetComponent<Skill_Data_Control>().init_skill_data;
                init_character_data.skill_4 = skill_grid.transform.GetChild(4).gameObject.GetComponent<Skill_Data_Control>().init_skill_data;
